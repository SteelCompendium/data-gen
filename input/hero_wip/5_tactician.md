...
| **You shout a phrase that galvanizes your team.* **Ranged** | **Maneuver** |
| --- | ---:|
...
| Image: triangular ruler Ranged 10 | Image: target Two allies |
|--------------------------------------|-----------------------------|
|--------------------------------------|-----------------------------|
...
| **Melee, Strike, Weapon** Self; see below | **Main action** Self |
|-----------------------------------------------------------------------------------|--------------------------------------------------------------------|
|-----------------------------------------------------------------------------------|--------------------------------------------------------------------|
...
| ----------------------------------------------|-----------------------------------------------------|
| (triangle ruler) Ranged 5 | (spiral arrow) One creature |
...
| **The purpose of a charge is to break their morale and force a retreat.*** | **Maneuver** |
| ----------------------------------------|--------------------------------------|
| Self | Self |
...
| **Melee, Ranged, Strike, Weapon** | **Main action** |
| -----------------------------------------------|-----------------------------------------------|
| Image: triangle symbol Melee 1 or ranged 5 | Image: circular arrow symbol Two creatures |
...
| ≤11 | <b style="background:black; color:white; padding:**0 2px;">A &lt;WEAK** , dazed (save ends) |
|------------------|---------------------------------------------------------------------------------------------|
|------------------|---------------------------------------------------------------------------------------------|
