...
## <span id="page-263-2"></span>**Characteristics and Tests**
...
<span id="page-263-3"></span>You make a Presence test whenever you attempt a risky task that requires the use of your force of personality. Presence tests are most often used to gain trust, project confidence, and influence and lead other creatures.hough it's easier than easy, then
...
|--------------------------|-------------------------------|-------------------------------|-------------------------------|
| Power Roll               | Easy Test<br>Outcomes         | Medium Test<br>Outcomes       | Hard Test<br>Outcomes         |
| ≤11                      | Success with<br>a consequence | Failure                       | Failure with<br>a consequence |
| 12–16                    | Success                       | Success with<br>a consequence | Failure                       |
| 17+                      | Success with<br>a reward      | Success                       | Success                       |
| Natural 19 or 20         | Success with<br>a reward      | Success with<br>a reward      | Success with<br>a reward      |
...
á You succeed on the task and incur a consequence.

- é You succeed on the task.
- í You succeed on the task with a reward.
...
- á You fail the task.
- é You succeed on the task and incur a consequence.
- í You succeed on the task.
...
- á You fail the task and incur a consequence.
- é You fail the task.
- í You succeed on the task.
...
## <span id="page-264-0"></span>**Test Outcomes**
...
![](_page_266_Picture_15.jpeg)

## <span id="page-267-2"></span>**NPCs Roll for Deceptive Tasks**
...
## <span id="page-267-0"></span>**Opposed Power Rolls**
...
## <span id="page-267-1"></span>Reactive Tests
...
#### <span id="page-267-3"></span>**Optional Rule: Secret Reactive Tests**
...
## <span id="page-268-0"></span>Skills
...
| Endurance  | Remain engaged in strenuous activity over a long period<br>of time |
...
| Skill               | Use                                                                                           |
|---------------------|-----------------------------------------------------------------------------------------------|
| Criminal Underworld | Knowing about criminal organizations, their crimes, their<br>relationships, and their leaders |
| Culture             | Knowing about a culture's customs, folktales, and taboos                                      |
| History             | Knowing about significant past events                                                         |
| Magic               | Knowing about magical places, spells, rituals, items, and<br>phenomena                        |
| Monsters            | Knowing monster ecology, strengths, and weaknesses                                            |
| Nature              | Knowing about natural flora, fauna, and weather                                               |
| Psionics            | Knowing about psionic places, spells, rituals, items, and<br>phenomena                        |
| Religion            | Knowing about religious mythology, practices, and rituals                                     |
| Rumors              | Knowing gossip, legends, and uncertain truths                                                 |
| Society             | Knowing noble etiquette and the leadership and power<br>dynamics of noble families            |
...
## <span id="page-272-0"></span>Assist a Test
...
- á You get in the way or make things worse. The creature takes a bane on their test.
-
- <sup>é</sup> Your help grants the other creature an edge on their test. <sup>í</sup> Your help gives the other creature a double edge on their test.
...
## <span id="page-272-1"></span>Hide and Sneak
...
#### <span id="page-273-0"></span>Searching for Hidden Creatures
...
## <span id="page-274-0"></span>Group Tests
...
## <span id="page-275-0"></span>Montage Tests
...
## <span id="page-276-0"></span>**Total Successes and Failures**
...
## <span id="page-276-1"></span>**Montage Test Outcomes**
...
## <span id="page-276-2"></span>**Sample Montage Test**
