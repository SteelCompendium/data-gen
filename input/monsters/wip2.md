...
| **📏 4 x 1 line within 1** | **🎯 Each creature and object in the area ** |**Trigger:** The pillar is destroyed, or a pressure plate, switch, or other linked trigger is activated.
...
- **≤11:** The creature triggers the portcullis and is affected as if in
...
- **12-16:** The pulley is deactivated but the creature is slowed (EoT). 3 The pulley is deactivated and doesn't trigger.
...
- **12-16:** The ram is deactivated but the creature is slowed (EoT). 3 The ram is deactivated and doesn't trigger.
...
- **≤11:** 5 damage
- **12-16:** 9 damage; A < 0 push 1 3 12 damage; A < 1 push 2
...
- **12-16:** The iron dragon is deactivated but the creature is slowed (EoT). 3 The iron dragon is deactivated and can't be used.
