...
🗡 **Flashing Fangs 2d10 + highest characteristic (Signature Ability)**
...
**Effect:** The vampire rebel gains temporary Stamina equal to any
corruption damage dealt.
...
**Effect:** The vampire rebel changes their form into a bat. In bat form, 
their size is 1T and they can fly. The vampire rebel then shift s u p t
their speed, then regains their true form. If they can't fit in their cu-
rent space when they return to their true form, they take 10 damage
and are pushed to the nearest unoccupied space.

⭐️ **Agonizing Bloodthirst**

The vampire rebel has speed 10 while any creature within 10
squares of them is bleeding. If the vampire rebel is able to deal
damage to a bleeding creature on their turn and does not do so, 
they take 5 corruption damage at the end of their turn.Vampire Rebel Level 4 Harrier Retainer
Undead, Vampire
|   **1M**<br>Size   |  **5**<br>Speed   | **48**<br>Stamina |  **0**<br>Stability   | **4**<br>Free Strike |

🗡 **Blood Surge 2d10 + highest characteristic Encounter**
...
**Effect:** Before the strike, the vampire rebel shifts up to their speed .
If the vampire rebel has temporary Stamina, they can expend it, 
dealing an extra 2 corruption damage for each point of temporary
Stamina expended this way.Level 7 Retainer Advancement Ability

🔳 **Exsanguination 2d10 + highest characteristic Encounter**

| **Area, Magic** | **Main action** |
| --- | ---:|
| **📏 3 cube within 1** | **🎯 Each enemy in the area** |

- **≤11:** 7 corruption damage; M <w] bleeding (save ends)
- **12-16:** 11 corruption damage; M <v] bleeding (save ends)
- **17+:** 16 corruption damage; M <s] bleeding (save ends)Level 10 Retainer Advancement Ability