...
*All words written below corresponding stained glass illustrations:*
- Human
- Devil
- Polder
- Time Raider
...
what polders consider sophisticated) while last names are typically common, compound words. No one knows why they do this.
...
"I see no reason to choose," Embers said smoothly. "But in my case, as well as the case of these villagers, justice would *be* revenge."
...
Your stone skin affords you potent protection. You have a +6 bonus to Stamina, and that bonus increases by 3 each time you gain a new level.
...
C hildren of the sylvan celestials and masters of the elf-haunted forests called wodes, wode elves see all forests as their domain by birthright. They know and enjoy their reputation among humans for snatching children who wander too far into the woods. Humans *should* fear the trees.
...
"Well …" Jeremy looked at Dade, who was no help. "We do, but …" Llyander made a theatrical, dismissive gesture with one arm. "Well, it is the same thing, then. But for our people, it is a game we practice all our

lives! We would be poor protectors of the wode if we could not conceal ourselves within it."
...
| é 3 + M or A damage; A <v (save="" ends)<="" slowed="" th=""><th></th></v> |  |
|----------------------------------------------------------------------------|--|
|                                                                            |  |
...
Your mind allows you to maintain your focus in any situation. You can't become dazed.
...
"No offense," John said. "It's just that … well … we only ever see one of you when you come down from the hills. Following your doom. Which is usually a …" John tried to find a less dramatic way to say it, but nothing came to mind. "A tide of ill-omen."
...
1 Professor Cilliarwn did not elaborate on this.
...
A n anger that cannot be hidden. A fury that drives them in battle. Orcs are famed throughout the world as consummate warriors—a reputation that the peace-loving orcs find distasteful.
...
The orc hopped down from the corpse of the defeated. "Elg was an ruin ogre," she said. "Infected with a troll disease. An inconvenience for troll-kin but to an ogre …" She indicated the mutated ogre. "You weren't to know."
...
Korva nodded without looking at the dwarf.
...
![](https://latex.codecogs.com/svg.image?\text{(Target&space;symbol)})

![A black and white semicircle target-like graphic, no visible text.](#)

*There is no text in the provided image, only a geometric graphic.*

"We just got started," John said defensively. "And I'm working on a friend of mine. We'll see. One of the Storm Knights."

Khorva frowned. "I thought the Dragon Phalanx were dead." "Yeah well," John said, wishing Vaant was here to watch this. "They

couldn't kill him," he broke out in a feral grin. "And he wouldn't yield." Khorva nodded once, impressed.
...
"Because we are not fools," Embers said, and Khorva locked eyes with her, standing a little straighter. The orc's brown eyes burned and it seemed the group rose somewhat in the her estimation. She nodded once.
...
"A family came to me. They're desperate. Their village is desperate.

They can either die, or fight. And they cannot fight. So they hired me." Khorva raised an eyebrow. "How much did they buy you for?" "Nine copper bits."

Khorva stared at him. "That's nothing"

John shrugged. "It was everything they had. The village sold everything they had left."

John relaxed as he saw Khorva's eyes soften. She understood. "A difficult offer to refuse," she said.
...
Khorva nodded. Respect. "Aye," she said. She looked at each hero then at John again. "Well," she said. "What do we do next?"
...
A fter humans, polders are the most numerous and diverse ancestry in Orden. They are not humans, but they live in and among humans and share their gods and culture. Almost every human culture in Orden has a polder saint or a human saint venerated by polder.
...
Jackson looked at his friend, the high elf void mage. "Am I crazy?" "You're not crazy." Embers smiled. She was enjoying watching two of her friends get to know each other. "John's just never run into one, it

seems." "Well, we're adorable," the polder said, and drank some ale.
...
"Do we have to … can we talk about something else, please?" John said. "I just …" The polder wouldn't let it go. "You seriously never … you

never been to an inn? Cavall's teeth, I can't count how many inns and taverns I've been to run by polders, got polders in the kitchen or waiting tables. One of the only two things we're good at, I think."
...
"Yeah, okay. To business: How to rally the people." The polder took the question seriously. "It's not hard. First, we need someone they'll rally around. I could make someone up, invent a local folk hero, but if we can

![A black semi-circle with a vertical and horizontal line crossing at its center, resembling the upper-left quadrant of a target or crosshair. There is no text visible in the image.](image-url)

ANCESTRIES

find the real thing? They just need to look the part, that's all. I'll take care of the rest."
...
This image contains a black-and-white target symbol composed of a circle with a cross through it and a filled black circle in the center. There is no textual content to transcribe in this image.
...
"I did! You asshole, I just did! I been trying to tell you for—" "Man, there is a *difference* between, 'Hey I think we're being

shadowed,' and, 'There's a deathless *copper* coming after us!' "
...
(No visible text is present in the provided image.)
...
![icon](data:image/png;base64,) Ranged 10

| Magic, Ranged, Strike                   | Main action                                                         |
|-----------------------------------------|---------------------------------------------------------------------|
| Image: diagonal ruler icon<br>Ranged 10 | Image: swirling sigil/magic icon<br>One creature bearing your sigil |

Power Roll +** R**eason ,** I**ntuition or** P**resence:

| <span style="border:1px solid #000; border-radius:5px; padding:2px 6px;">≤11</span>   | 3 + <b><span style="border:1px solid #000; padding:2px 6px;">R</span>, <span style="border:1px solid #000; padding:2px 6px;">I</span></b> or <b><span style="border:1px solid #000; padding:2px 6px;">P</span></b> damage; slide 1 |
|---------------------------------------------------------------------------------------|------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
| <span style="border:1px solid #000; border-radius:5px; padding:2px 6px;">12-16</span> | 5 + <b><span style="border:1px solid #000; padding:2px 6px;">R</span>, <span style="border:1px solid #000; padding:2px 6px;">I</span></b> or <b><span style="border:1px solid #000; padding:2px 6px;">P</span></b> damage; slide 2 |
| <span style="border:1px solid #000; border-radius:5px; padding:2px 6px;">17+</span>   | 7 + <b><span style="border:1px solid #000; padding:2px 6px;">R</span>, <span style="border:1px solid #000; padding:2px 6px;">I</span></b> or <b><span style="border:1px solid #000; padding:2px 6px;">P</span></b> damage; slide 3 |
...
"Allies of all those who suffer, and seek justice," the dwarf announced.
...
![target symbol](https://via.placeholder.com/15/000000/000000?text=+)

*The image displays a crosshair or target symbol, consisting of concentric circles and a cross intersecting at the center. There is no text visible in the provided image.*
...
| <b>Power Roll + <span style="font-weight:bold;">R</span>eason, <span style="font-weight:bold;">I</span>ntuition or <span style="font-weight:bold;">P</span>resence:</b>                                                                                                                                                                                                                                                        |                                                        |
| <b>≤11</b> 2 + <span style="font-weight:bold;">R, I</span> or <span style="font-weight:bold;">P</span> damage;<br><b>12–16</b> 5 + <span style="font-weight:bold;">R, I</span> or <span style="font-weight:bold;">P</span> damage; push 1<br><b>≥17</b> 7 + <span style="font-weight:bold;">R, I</span> or <span style="font-weight:bold;">P</span> damage; push 2; <span style="font-weight:bold;">M &lt; STRONG</span> prone |                                                        |
...
| Power Roll + Reason , Intuition or Presence:<br>á<br>2 + R , I or P psychic damage; slide 1 |                          |
...
(Revenants are missing from this table because they don't gain their ancestry until after they die.) If you'd rather quickly create a culture based on a cultural archetype, such as a noble house or a pirate crew, use the Archetypical Cultures table, then add a language that fits the culture's concept.

|                  |             | Typical Ancestry Cultures |              |            |
|------------------|-------------|---------------------------|--------------|------------|
| Ancestry         | Language    | Environment               | Organization | Upbringing |
| Devil            | Anjali      | Urban                     | Bureaucratic | Academic   |
| Dragon<br>knight | Vastariax   | Secluded                  | Bureaucratic | Martial    |
...
Your culture's language aspect determines how the people of your culture communicate. Languages in Ordren below discusses the many languages of the world of Orden, including Caelian—the language of the fallen empire that once dominated that world.
...
Living among a small population, most folks in a rural community learn a trade and are handed down bits of essential knowledge to help their community survive. For example, when a rural culture has only one blacksmith, it's important to have an apprentice already learning at the

anvil well before that smith starts to get old. If the only priest in town gets the sniffles, folks want an acolyte ready to wear the fancy robes should the worst occur.
...
Bureaucratic cultures are steeped in official leadership and formally recorded laws. Members of such a culture are often ranked in power according to those laws, with a small group of people holding the
...
**Skill Options:** One of the Blacksmithing skill (from the crafting skill group.), the Handle Animals skill (from the interpersonal group.), or a skill from the exploration group. (*Quick Build:* Lift.)
...
A hero with a martial upbringing was raised by warriors. These might have been the soldiers of an established army, a band of mercenaries, a guild of monster-slaying adventurers, or any other folk whose lives

![](_page_57_Picture_26.jpeg)

![Target symbol](image)

revolve around combat. Heroes with a martial upbringing are always ready for a fight—and they know how to finish that fight.
...
trolls, voiceless talkers Common language of the World Below
...
**Vaslorian Languages by Ancestry**
...
Szetch Goblins, radenwights Tholl Higher demons, gnolls
...
Urollialic Olothec Variac Gnomes, olothec,
...
Kethaic Kobolds Patois of Vastariax and Caelian Khelt Bugbears, fey Offshoot of Kheltivari Khoursirian Polder, humans Distant offshoot of Khamish
...
Language Elder dragons Language of magic
...
| Old Variac     | Olothec,<br>voiceless talkers | Variac             | Kollar, the sunmetal                   |
...
![circle with crosshairs in corner](image)

There is no visible text present in the image; the image only shows a partial icon or target/crosshair shape in the bottom right corner. No markdown text extraction is possible from this image.

![A black-and-white bullseye or crosshair symbol with concentric circles and a cross in the center.](attachment:image.png)
...
The image provided contains no discernible text—only a black and white geometric symbol (a crosshair or target-like design). There is no extractable text content to represent in markdown.
...
(*Quick Build:* Disguise, Lie, Sneak.)
...
**Free Agent:** There was a time in your life when you used to sell information to the highest bidder. Your acts were unsanctioned by any one organization, but you were well-connected enough to trade in secrets. Politics never

3 mattered much to you until the information you sold wound up causing a ripple effect of harm that eventually destroyed the place you once called home. You became a hero to make up for your past.
...
5 and though you insisted your feelings were real, the deceit cut too deep for your love interest to ignore. They exposed you, spurned you, or died because of their closeness to you. You left the espionage business to become a hero with nothing to hide.

**Turncoat:** You spent your life in service of your country or an organization that upheld your values. During your undercover operations, you discovered

6 that everything you had been told was a lie. Whether you confronted your superiors or were exposed, you were stripped of your service medals before you left to become a true hero.
...
**Blood Money:** When you entered adulthood, you heard unsavory whispers about your family's fortune before learning that their wealth came at the

cost of others' suffering. Whether you shed light on the secret or not, you left to become a hero stripped of noble title.
...
whenever you were bored. Unfortunately, your counterpart became so good at imitating you that they convinced all those around you that you were an impostor. You lost contact with your family, but now pursue a heroic path free of the pomp of your old life.

**Wicked Secret:** One parent passed away when you were a baby and the other remarried years later. Then that parent died under suspicious circumstances. Their spouse ousted you, and you were banished (and possibly hunted.). Rising from tragedy, you now seek to right the wrongs of the world.

1

5

![A solid black circle inside a black target-like crosshair symbol. There is no text present in this image.](image-url)

*There is no text to represent in markdown from the provided image.*
...
(*Quick Build:* Blacksmithing, Carpentry.) **Languages:** One language

**Project Points:** 240 **Perk:** One crafting perk (*Quick Build:* Area of Expertise.)

d6 Inciting Incident

**Continue the Work:** A great hero was a fan of the things you created and gave you a generous commission to create your best work for them. While working on this commission, you and the hero became close friends. The day you finished the work was the same day they disappeared. To honor their legacy, you took up the mantle of a hero with the intent of finishing your friend's work.
...
**Skills:** The Rumors skill (from the lore skill group.), plus one skill from

the exploration group and one skill from the interpersonal group (*Quick Build:* Empathize, Endurance, Rumors.)
...
When a pickpocket stole that object, you chased them until you were in a part of the city you no longer recognized. With a jolt, you realized you had no desire to return to your previous stomping grounds. You kept going, and you haven't looked back.

**Strange Charity:** A passerby dropped something in your cup. When you counted your day's collections, you found a magic coin among the coppers. You knew immediately that it was special. When the other beggars—your

friends, you thought—showed that they were ready to murder you for it, you killed several of them in self-defense before you fled, leaving behind the only semblance of community you had.
...
**Skills:** The Criminal Underworld skill (from the lore skill group.), plus two skills from the intrigue group (*Quick Build:* Criminal

Underworld, Pick Lock, Pick Pocket.)

**Languages:** One language

**Project Points:** 120 **Perk:** One intrigue perk (*Quick Build:* Criminal Contacts.)

d6 Inciting Incident

**Antiquity Procurement:** You stole, smuggled, and sold antiquities. In

- 1 your haste to make a quick sale, you didn't fully vet a client and they subsequently robbed your warehouse. When the items you had stolen were taken from you, you realized the harm you had caused. Now you adventure to find those items you lost and return them to where they belong.
...
4 exposed, and after a narrow escape, you reevaluated your life. Under a new identity, you work as a hero and hope no one looks at your past too closely.

**Simply Survival:** Stealing was a matter of survival for you and not what defined you—at least in your mind. But when your thieving actions led to

5 innocent folk being harmed, you knew you could be better. You turned your back on your old life, though your old skills still come in handy.
...
**Lost Faith:** You devoted your life to ministering to the sick and needy, alongside other charitable work. Time and time again, tragedy struck those you served without rhyme or reason. Your prayers went unanswered, and

4 your efforts went thankless. Eventually, you lost your faith in a higher power, and you left your church or temple to do good outside of any religious affiliation.

**Near-Death Experience:** While serving at a religious institution, you almost died in an accident. When you woke, you had lost all memory of ever having worked for the church or temple. Though the clergy encouraged you to

5 stay, you left to forge a new path. Your sense of altruism—whether instilled in you by your past work or a part of who you naturally are—guides you in your life.

**Taxing Times:** The faith-based organization you were once part of became corrupt. It used its status in the community to accumulate wealth through tithes, while its leaders sought political appointments. During a season of

6 drought, the institution stockpiled resources and refused to give aid, resulting in the deaths of many. You became a hero to fight against such corruption and to honor those you lost.

![](_page_63_Picture_52.jpeg)

There is no text in the provided image, only a partial graphic or symbol resembling a target or registration mark.

The image is of a black and white circular crosshair or target symbol. It contains no text.
...
**Missing Piece:** You made an important but dangerous discovery about a treasure or ancient ritual that could spell mass destruction. Then the

2 unthinkable happened when an unscrupulous colleague, spy, or treasure hunter stole your research notes. You're looking for the thief now, and anyone else who might use such discoveries for ill.

**Nothing Belongs in a Museum:** Exploring distant lands to collect valuable artifacts for cultural institutions was once your way of life. But when people died trying to reclaim one of the objects you took, you realized the truth.

3 Your work was part of a larger problem of cultural theft, and the best place for these significant objects wasn't in a museum but with the people who created them. Setting out to return what had been taken and to protect others from theft set you on the path to become a hero.
...
**Wanderlust:** You saw yourself as an observer and operated within a code of conduct. You swore to never interfere with a group by exposing them to your technology, knowledge, or values. But when faced with a moral

5 conundrum, you either broke your code or stood idly by—and suffered the consequences. During this incident, you lost your observation journal but became a hero who refuses to let evil stand unchecked.

**Wind in Your Sails:** As a seafaring explorer, you lived to chart unknown courses. Though travel on the high seas was fraught with danger, the

6 destination was always rewarding in riches, knowledge, or some other meaningful benefit. But your luck ran out when your ship was destroyed by pirates or other enemy forces. Now you've taken to protecting those who seek safe passage while also hoping to avenge your crew.
...
**Skills:** The Handle Animals skill (from the interpersonal skill group.), plus two skills from the exploration group (*Quick Build:* Drive,
...
**Blight:** A horrible blight swept over your homeland, sickening the livestock and causing crops to rot. No one knows whether the blight is of natural origin or something more malevolent, but you set out in search of a way to

cleanse the land of this affliction. **Bored:** You've always wanted so much more than gathering eggs and milking

2 cows. You kept a secret journal of your dreams, filled with all the things you wanted. When your parent found the journal, they burned it and told you to keep your head out of the clouds. In response, you gathered what you could in a pack and left everything else behind, seeking a life of adventure.

**Cursed:** While tilling your fields, you found something in the dirt. Perhaps it was a chipped and dented weapon, a piece of ancient jewelry, or something

3 altogether unique. Excited by your find, you showed it to a loved one, but when they touched it, something happened. You now know it was a curse conveyed by the item, though you don't know why it affected them and not you. You left your old life in search of answers.
...
**Stolen:** Your family bred horses—beautiful creatures that few could rival on the track and in the jousting lists. When a local noble arrived with an offer

6 to buy your prized stallion, your father refused. The noble struck him down where he stood and stole the horse. Without that stallion, the renowned bloodline would end. You intend to get them back—and get revenge.

Draw Steel

![A symbol of a black bullseye centered in a white background, with two black intersecting perpendicular lines crossing through the center, all inside a black circular outline.](image_url)

*There is no text present in this image, only a bullseye/target symbol graphic.*

![Target symbol](image_url)
...
**Skills:** Two skills from the exploration skill group (*Quick Build:* 

Gymnastics, Jump.) **Languages:** One language **Renown:** +2 **Perk:** One exploration perk (*Quick Build:* Friend Catapult.) d6 Inciting Incident

**Betrayed:** A local crime lord offered you money to throw your last bout,

1 promising that you'd live through the ordeal and get a cut of all the wagers placed on the match. You upheld your end of the deal—which made the knife in your back after the bout so surprising. You woke in a shallow grave, barely alive, and ready to mete out justice.
...
**New Challenges:** You earned every title you could. You beat every opponent willing to face you in the arena. Your final battle with your rival ended with you victorious—and still you were unsatisfied. Other, greater foes are out there. And you mean to find them.

**Scion's Compassion:** You were born a noble, but the duplicitous and power-hungry nature of your family had you seeking your own fortune in

5 the arena. You saw that competitors brought there by circumstance and not choice suffered. You gave all you could of your family money to those lessfortunate folk, and then set out to make a real difference in this cruel world.
...
**Deep Sentinel:** Spending your days cleaning and maintaining the sewers doesn't make you many friends. But you found companionship among the

1 rats. You fought the monsters that hunted your friends, and which others ignored. After making the sewers safe for the rats, you decided to take your talents to the surface and serve other humanoids who might appreciate your efforts in the same way.
...
**Shining Light:** You kept a lighthouse along the constantly stormy cliffs of your village with your mentor. On a clear and sunny day, your mentor

5 vanished. Finding only a cryptic notebook filled with his musings on the supernatural, you left to find out what really happened. The trail has gone cold for now, and you're helping others find their loved ones in the meantime.

**Slow and Steady:** You labored silently as an uncaring boss drove those around you into the ground, pushing you to work harder to lessen the burden on your companions. But when the boss pushed too far and killed a friend of yours, you led an uprising against them. That was the start of your
...
There is no visible text present in the provided image.
...
from the lore group (*Quick Build:* Magic, Monsters, Timescape.) **Languages:** One language
...
**Nightmares Made Flesh:** Your attempts at magic have always been unpredictable. A powerful mage promised to help you gain control. During your training, a terrible nightmare caused your body to flare with magic and pull the monster of your nightmare into the waking world. The horror

**Otherworldly:** While studying magic, you accidentally sent yourself from your original world to this one. Now you're stranded here, hoping to find ancient texts or powerful magic treasures that might transport you back home. A life of adventure it is!

escaped. You left, seeking to vanquish their vileness.

**Ultimate Power:** The mage you worked for was a kindly old soul, but the basic magic they taught you always seemed like a small part of something bigger. It wasn't until you met an adventuring elementalist that you realized hitting the road as a hero was the only way to truly improve and hone your skills. You resigned your apprenticeship and found yourself walking the path of a hero the next day.
...
**Skills:** The Music or Perform skill (from the interpersonal skill group.), plus two more skills from the interpersonal group (*Quick Build:* Flirt,
...
**Cursed Audience:** During a performance, you watched in horror as the audience was suddenly overcome by a curse that caused them to disintegrate before your eyes. You aren't sure what happened, but seeking an answer quickly led you to places where only heroes dare to go.
...
**Songs to the Dead:** Your performances have always been tinged with a bit of melancholy. During a particularly soulful performance, spirits disturbed the living audience and sat in their chairs. They begged you to prevent

their demise, providing no other details before disappearing. You set out to determine if you could help your most dedicated fans.

**Speechless:** A heckler's mocking words left you utterly speechless during a performance, stinging your pride and stirring your arrogance. The incident strained your legendary voice, and you could speak only in soft whispers. The heckler was a fey trickster who stole your voice, promising to give it back after you accomplished real good in the world.
...
This image does not contain any text. It displays a graphic resembling a target or crosshair symbol, with a bold black dot at the center surrounded by a circle divided into four quadrants by two intersecting lines.
...
**Skills:** Two skills from the interpersonal skill group (*Quick Build:* Lead, Lie.) **Languages:** One language **Renown:** +1 **Wealth:** +1 **Perk:** One interpersonal perk (*Quick Build:* Engrossing Monologue.)
...
**Insurrectionist:** You secretly funded a rebel organization intent on

2 overthrowing the corrupt establishment. Someone discovered your treason, and you were forced to flee or risk execution. You became a hero to live and fight another day on behalf of those who have no power.

**Respected Consul:** You were a seneschal to a leader, able to sway their

3 opinions. But gossip convinced the leader you were plotting a coup, and you were ousted from their circle of influence. You became a hero to continue your work making meaningful change in the world.
...
5 against you, they gave you an opportunity to leave the world of politics behind. Saved from public humiliation, you now use your skills for the greater good.

**Unbound:** The red tape required to achieve anything through your political position resulted in a crisis being mishandled and countless people harmed or killed. After that unfortunate event, you resolved to live unfettered by bureaucratic interference, seeking to do good through action, not paperwork.
...
**Skills:** Two skills from the lore skill group (*Quick Build:* History, Magic.) **Languages:** One language **Project Points:** 240 **Perk:** One lore perk (*Quick Build:* Expert Sage.)
...
**Paper Guilt:** While transcribing ancient texts, you and another scribe discovered a shelf of long-forgotten books. At your suggestion, your

4 companion started work on one and vanished along with the tome. Your guilt drove you to seek out your still-missing friend and prevent others from falling to similar dangers.
...
**Vanishing:** At first you thought it was your imagination, and you brushed off the disappearance of random sentences in historical books. Then as the books changed to entirely blank pages, the disappearances became difficult

to ignore, particularly those involving ancient or critical text. Driven by the desire to preserve knowledge, you have made it your purpose to restore and reverse those vanishing texts before they forever disappear.
...
**Deserter:** It was in the middle of a pirate raid (whether you were part of it or targeted by it.) that you realized you no longer yearned for a sailor's life. You used the chaos of the moment to slip away unnoticed. You now work

2 as a hero in an effort to either end the piracy of others or atone for your past deeds, but you fear the day your old crew finds you and punishes you for your desertion.
...
5 **Marooned:** There was a mutiny, and you were on the losing side. You were marooned on an island and escaped when a merchant vessel was blown off course by a storm and found you. Your reputation is ruined among sailors, so

you seek adventure elsewhere. **Water Fear:** A catastrophic storm hit while you were at sea, destroying your ship and leaving you as the only survivor. Once you recovered, you tried to sign on with another ship, but the thought of the open water turned your

6 legs to jelly. Instead, you've taken on the role of a traveling hero to make ends meet.
...
**Out of Retirement:** You had a long and storied career as a soldier before deciding to retire to a simpler life. But when you returned to your old home,

2 you found your enemies had laid waste to it. Now the skills you earned on the battlefield are helping you as you become a different kind of warrior one seeking to save others from the fate you suffered.
...
**Sole Survivor:** You were the last surviving member of your unit after an arduous battle or monstrous assault, surviving only through luck. You turned

4 away from the life of a soldier then, seeking to become a hero who could stand against such threats.

**Stolen Valor:** Tired of eking out an existence on the streets, you enrolled in the military. However, you were unable to escape your lower-status
...
1 other wardens spoke in favor of these outsiders, and allowed them in to despoil nature. Refusing to watch your homeland destroyed, you left. Now you help others avoid such a fate.
...
- everything, magical and mundane, to stop the scourge, but it continues to spread. As such, you've set out in search of a cure or an unblighted land to protect.
...
**Honor the Fallen:** A group of heroes arrived in your territory with trouble close on their heels. You fought alongside them to turn back the evil, but

4 it was too much. The heroes fell, and your wilderness was forever altered. Though your lands are beyond saving, there are other lands you can help.

**Portents:** There were signs. You tried to ignore them, but when a great beast died at your feet, you had to recognize the truth. You were meant to leave

5 your home territory, meant to fight a battle for the fate of all lands—and so you gave up the only life you've ever known.

**Theft:** You were responsible for guarding something precious, something vital to your region's survival. But you let someone in, and they betrayed your trust by stealing the thing you were meant to guard. You left your

chosen territory to atone for your mistake.
...
**Corruption Within:** You joined the force to help the helpless and bring justice to those wronged. You weren't prepared for the rampant corruption

2 reaching the top of your organization. You refused to cover for your fellow officers and were told in no uncertain terms to leave town or face the consequences. Now you travel as a hero, acting as the protector you always wanted to be.

**Frame Job:** Your partner was murdered. That much is irrefutable. But you didn't do it, despite what the evidence implies. When it became clear you'd

3 take the fall, you fled, leaving everything behind. Not content to cower in the shadows, you decided to adventure under a new name while you work to clear your own.
...
4 before you could find out more, they disappeared. No longer sure who you could trust, you slipped away and sought a new life. Now you do what good you can and search to find the truth.

**One That Got Away:** A violent or depraved criminal began targeting you perhaps stealing something personal or hurting someone you love—after

5 slipping through your grasp. You left your career to pursue the criminal, but the trail has gone cold … for now. Might as well help folk in the meantime.

**Powerful Enemies:** You made it your responsibility to root out and bring down the region's foremost crime syndicate. They sent goons to burn down your home and teach you a lesson, leaving you bleeding in the street with

nothing left except your life. You've since taken on the life of a hero to gain the power and influence you need to destroy the syndicate once and for all.

![A solid black circle at the center, surrounded by a thin black ring, with four lines (vertical, horizontal, and diagonal) going through the center, forming a crosshair or target symbol.](image)
...
![Black and white circular target symbol, sometimes used as a printer's registration mark](image-url)
...
The tactician's 1 aura emanates 1 square in every direction from them. If the tactician moves, the aura moves with them. Any creatures the tactician comes within 1 square of during their move enters the aura's area of effect.

![Target symbol](https://upload.wikimedia.org/wikipedia/commons/thumb/2/22/Crosshair.svg/1024px-Crosshair.svg.png)

*Note: The image above depicts a crosshair or target symbol. There is no visible text to reproduce.*

![](_page_74_Picture_1.jpeg)

###### Burst

A tactician uses a 1 burst ability, which targets all squares within 1 square of them. The elementalist uses a 2 burst ability, which targets all creatures within 2 squares of them, including the war dog crucibite.

![](_page_74_Picture_4.jpeg)

###### Cube

The talent uses a "2 cube within 5" ability. The cube is 2 squares on all sides and must target an area that includes at least 1 square within 5 squares of the talent.

If the talent uses a "2 cube within 1" ability, that ability must target an area that includes at least 1 square that is adjacent to the talent.
...
Talking about a straight line area of effect on an encounter map doesn't mean the line can only be a straight vertical or horizontal line of contiguous squares. It means that an imaginary straight line traced through the center of the area of effect would be perfectly straight. Each square such an imaginary line would pass through is affected by the ability.
...
![](_page_74_Picture_29.jpeg)

The image contains a black and white crosshair or bullseye symbol. There is no textual content to transcribe.
...
The elementalist uses a "5 × 1 line within 1" ability. Each bluehighlighted area abides by the rules for lines. The line must only move in one direction.

![](_page_75_Picture_21.jpeg)

The elementalist uses a "4 wall within 10" ability. The blue squares indicate a few different placements of the wall that abide by the rules. The red squares show ways in which the wall can't be placed.

73

Classes

![A target-like symbol with a black circle divided into quadrants by a crosshair inside a larger circle. No text is present.](image-url)
...
Certain damage-dealing abilities note that damage as a number followed by a plus sign (+) and the letter M, A, R, I, or P. The indicated letter means you add your characteristic score—either Might, Agility, Reason, Intuition, or Presence—to the damage dealt by the

ability. Certain abilities let you use your highest characteristic score for the power roll.
...
Unless otherwise indicated, any effects that are determined by a power roll's tier outcome occur after the power roll's damage has been dealt to all targets. If an ability creates multiple effects, those effects resolve in the order in which they are presented.
...
- á 5 holy damage; a<0, prone
- é 8 holy damage; a<1, prone
- í 11 holy damage; A<2, prone and can't stand (save ends)

74

Draw Steel

This image contains only a graphic symbol resembling a crosshair or a target. There is no text present in the image to transcribe.
...
If an ability's effect allows you to take a main action, a maneuver, a move action, or a triggered action, the cost of doing so is subsumed in the ability's type entry on the first line below the flavor text. You never need to spend additional time to use an ability. For example, the

![A black crosshair symbol inside a circle. There is no text present in this image.]

shadow's Black Ash Teleport ability is a maneuver that allows you to teleport and then use the Hide maneuver as its overall effect. Using the Hide maneuver is part of the maneuver to use the ability, so that you don't need to have another maneuver available to do so.
...
![A black circle in the center of a black-and-white crosshair.](image)
...
Draw Steel.indb 78 6/24/25 2:48 PM

The image contains a target or crosshair symbol. There is no text present in the image to be represented in markdown.
...
- knowing that an open mind is an unguarded fortress. You have the Read Person skill.
...
**Magic, Ranged Maneuver** e Ranged 10 x One enemy
...
When a creature judged by you is reduced to 0 Stamina, you can use a free triggered action to use this ability against a new target. Additionally, you can spend 1 wrath to take one of the following free triggered actions:
...
![A target or crosshair icon, with intersecting vertical and horizontal lines inside a circle, dividing the circle into four quadrants and a solid-filled circle at the center intersection. There is no textual content present in the image.](image-url)

*No text is present in the image.*

![A thick black crosshair/cross target symbol, with a filled black circle at its center. No text is present.](attachment:image.png)
...
**Magic Main action** e Self x Self
...
| Magic                              | Maneuver                   |
|------------------------------------|----------------------------|
| Image: triangle/ruler icon<br>Self | Image: target icon<br>Self |
...
![](_page_83_Picture_38.jpeg)

![](_page_84_Picture_70.jpeg)
...
**Area, Magic, Melee, Weapon Main action** e 2 cube within 1 x Each enemy in the area

Z cube within 1

- Power Roll + P**resence**:
- á 2 holy damage; push 1 é 4 holy damage; push 2
- í 6 holy damage; push 3
...
Power Roll + P**resence**: á 5 + P psychic damage é 7 + P psychic damage
...
á 2 + M holy damage; P<w, slowed (save ends) é 5 + M holy damage; P<v, slowed (save ends)
...
|--------------------|--------------------------|
| ≤11                | 3 + <b>M</b> holy damage |
| 12–16              | 5 + <b>M</b> holy damage |
| 17+                | 8 + <b>M</b> holy damage |
...
| ≤11   | 3 + <b>M</b> holy damage |
|-------|--------------------------|
| 12-16 | 6 + <b>M</b> holy damage |
| 17+   | 9 + <b>M</b> holy damage |
...
| ≤11   | 3 + <b>M</b> damage; push 1 |
|-------|-----------------------------|
| 12–16 | 6 + <b>M</b> damage; push 3 |
| 17+   | 9 + <b>M</b> damage; push 5 |
...
| <b>Magic, Melee, Strike, Weapon</b><br><span style="font-size:16px;">▲ Melee 1</span><br><br><b>Power Roll + <span style="border:1px solid black;padding:2px;">M</span>ight:</b> | <b>Main action</b><br><span style="font-size:16px;">⌛ One creature or object</span> |
|----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|-------------------------------------------------------------------------------------|
|----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|-------------------------------------------------------------------------------------|
...
![](_page_84_Picture_67.jpeg)

- ![triangle icon](data:image/png;base64,) Melee 1
...
| <b>Power Roll + <span style="border:1px solid black; padding:0 2px;">M</span>ight:</b><br><b>≤11</b> 6 + <span style="border:1px solid black; padding:0 2px;">M</span> holy damage; grabbed<br><b>12–16</b> 9 + <span style="border:1px solid black; padding:0 2px;">M</span> holy damage; grabbed<br><b>17+</b> 13 + <span style="border:1px solid black; padding:0 2px;">M</span> holy damage; grabbed                                                                                                                                                                                                                                                                                                                                                                                                                                                                                |                                    |
| <b>Effect:</b> If the target makes a strike against a creature while grabbed this way, you can spend 3 wrath to deal holy damage to them equal to your Presence score, then change the target of the strike to another target within the strike's distance.                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                             |                                    |
| <b>Behold the Face of Justice! (5 Wrath)</b><br><i>You attack a foe and your enemies behold a vision of the true nature of your resolve.</i>                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                            |                                    |
| Magic, Melee, Ranged, Strike, Weapon                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                    |                                    |
| Melee 1 or ranged 5                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                     | <b>Main action</b><br>One creature |
| <b>Power Roll + <span style="border:1px solid black; padding:0 2px;">M</span>ight:</b><br><b>≤11</b> 3 + <span style="border:1px solid black; padding:0 2px;">M</span> holy damage; if the target has <span style="border:1px solid black; padding:0 2px;">P &lt; WEAK</span> , each enemy within 2 squares of them is frightened of you (save ends)<br><b>12–16</b> 5 + <span style="border:1px solid black; padding:0 2px;">M</span> holy damage; if the target has <span style="border:1px solid black; padding:0 2px;">P &lt; AVERAGE</span> , each enemy within 2 squares of them is frightened of you (save ends)<br><b>17+</b> 8 + <span style="border:1px solid black; padding:0 2px;">M</span> holy damage; if the target has <span style="border:1px solid black; padding:0 2px;">P &lt; STRONG</span> , each enemy within 2 squares of them is frightened of you (save ends) |                                    |
| <b>Effect:</b> Each enemy frightened this way is pushed up to 2 squares away from the target and takes psychic damage equal to your Presence score.                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                     |                                    |
| <b>Censored (5 Wrath)</b>                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                               |                                    |
| <i>Judged and sentenced.</i>                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                            |                                    |
...
á 2 + M holy damage é 3 + M holy damage
...
|----------------------------------------------------------------------------------------|---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
| <i>The gods judge, fire cleanses.</i>                                                  |                                                                                                                                                                                                                                 |
| <b>Magic, Melee, Ranged, Strike, Weapon</b>                                            |                                                                                                                                                                                                                                 |
| Melee 1 or ranged 5                                                                    |                                                                                                                                                                                                                                 |
| Main action                                                                            | One creature                                                                                                                                                                                                                    |
| <b>Power Roll + <span style="border:1px solid #000;padding:1px 4px;">Might</span>:</b> |                                                                                                                                                                                                                                 |
| $≤11$                                                                                  | 5 + <span style="border:1px solid #000;padding:1px 4px;">M</span> holy damage; <span style="border:1px solid #000;background:#000;color:#fff;padding:1px 4px;">M &lt; WEAK</span> the target has fire weakness 3 (save ends)    |
| $12-16$                                                                                | 9 + <span style="border:1px solid #000;padding:1px 4px;">M</span> holy damage; <span style="border:1px solid #000;background:#000;color:#fff;padding:1px 4px;">M &lt; AVERAGE</span> the target has fire weakness 5 (save ends) |

í 12 + M holy damage; M<s, the target has fire weakness 7 (save ends)
...
á 8 + M holy damage; P<w, frightened (save ends) é 12 + M holy damage; P<v, frightened (save ends) í 15 + M holy damage; P<s, frightened (save ends)
...
á 5 + Pdamage; P<w, restrained (save ends) é 9 + Pdamage; P<v, restrained (save ends)

í 12 + P damage; P<s, restrained (save ends)

- If *damage*, **contents** restrained (save ends)
...
![A black and white circular target with crosshairs and a bullseye in the center.](image-url)
...
(The image depicts a black and white target or crosshair symbol. There is no text visible in the image.)
...
e 2 aura x Each enemy in the area
...
| Area, Magic             | Maneuver                                  |
|-------------------------|-------------------------------------------|
| Image: aura icon 2 aura | Image: target icon Each enemy in the area |
...
![triangle icon](triangle_icon_url) 3 aura
...
| Ranged                      | Main action                         |
|-----------------------------|-------------------------------------|
| Image: ruler icon Ranged 10 | Image: target icon Self or one ally |
...
The image contains a symbol that looks like a crosshair or target, with a black circle in the center divided into four quadrants by white lines. There is no text present in the image.

![A circular target with crosshairs and a black center is depicted.](image-url)

*Note: The image appears to be a target or crosshair symbol. There is no textual content to reproduce in markdown.*

![](_page_89_Picture_1.jpeg)

**Area Maneuver** e 1 burst x Self and each ally in the area Power Roll + Presence: á Each target gains 1 surge. é Each target gains 2 surges. í Each target gains 3 surges.
...
- é Slide 5; I<v, dazed (save ends)

í Slide 7; I<s, dazed (save ends)
...
![triangle ruler icon](triangle_ruler_icon.png) Ranged
...
![](_page_91_Picture_58.jpeg)

The image shows a black circle centered within a crosshair. There is no textual content to reproduce.

![A circle with a black center intersected by a crosshair-like symbol](image)

*The image contains a black-filled circle with a white outline, intersected by a crosshair pattern. There is no textual content present in the image.*
...
|----------------------------------|---------------------------------------|
| Image: [triangle icon] Ranged 10 | Image: [target icon] Self or one ally |
...
![A black and white target or crosshair symbol with a bold central dot, surrounded by a circle, divided into four quadrants by vertical and horizontal lines.](image.png)
...
*You curse your foe to become a bane to their allies.* **Melee, Strike, Weapon Main action** e Melee 1 x One creature Power Roll + Might: á 9 + M damage; I<w, weakened (save ends) é 13 + M damage; I<v, weakened (save ends)

í 18 + Mdamage; I<s, weakened (save ends)
...
| Type                                                                                                                                                                                                                       | Ranged, Strike, Weapon |
|----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|------------------------|
| Range                                                                                                                                                                                                                      | Ranged 10              |
| Main Action                                                                                                                                                                                                                | One creature           |
| Power Roll + <b>M</b> ight:                                                                                                                                                                                                |                        |
|                                                                                                                                                                                                                           | 10 + <b>M</b> damage   |
| 12-16                                                                                                                                                                                                                      | 15 + <b>M</b> damage   |
| 17+                                                                                                                                                                                                                        | 21 + <b>M</b> damage   |
| <b>Effect:</b> Until the end of the encounter, while the target is judged by you, you can choose to make them the source of any of your abilities. Additionally, the target counts as an ally for the purpose of flanking. |                        |

| Melee, Strike, Weapon           | Main action                       |
|---------------------------------|-----------------------------------|
| Image: Triangle icon<br>Melee 1 | Image: Clock icon<br>One creature |
...
á 9 + M damage; I<w, dazed (save ends) é 13 + M damage; I<v, dazed (save ends) í 18 + Mdamage; I<s, dazed (save ends)
...
| ≤11   | 5 + <span style="background:black;color:white;">P</span> damage; I < <span style="background:black;color:white;"><b>WEAK</b></span> , slowed (save ends)    |
|-------|-------------------------------------------------------------------------------------------------------------------------------------------------------------|
| 12–16 | 9 + <span style="background:black;color:white;">P</span> damage; I < <span style="background:black;color:white;"><b>AVERAGE</b></span> , slowed (save ends) |
| 17+   | 12 + <span style="background:black;color:white;">P</span> damage; I < <span style="background:black;color:white;"><b>STRONG</b></span> , slowed (save ends) |
...
The image is entirely blank or only contains a solid color and does not contain any text to be represented in markdown.
...
á 5 + M damage; P<w, the target is banished (save ends) é 8 + M damage; P<v, the target is banished (save ends) í 11 + Mdamage; P<s, the target is banished (save ends)
...
| Power Roll + <b style="background:black;color:white;padding:0 2px;">M</b> ight: |                                                                               |
|---------------------------------------------------------------------------------|-------------------------------------------------------------------------------|
| ≤11                                                                             | 13 + <b style="background:black;color:white;padding:0 2px;">M</b> holy damage |
| 12–16                                                                           | 19 + <b style="background:black;color:white;padding:0 2px;">M</b> holy damage |
| 17+                                                                             | 26 + <b style="background:black;color:white;padding:0 2px;">M</b> holy damage |
...
You are the ultimate representation of your god's justice in the timescape. Whenever you use your Judgment ability, you can use a free triggered action to use a conduit domain effect (see Domain Piety and Effects in the Conduit section) associated with your chosen domain, or a domain you access with virtue (see below).
...
The first time each combat round that you deal damage to a creature judged by you, you gain 4 wrath instead of 3.

![](_page_95_Picture_19.jpeg)

Sorry, but the image provided appears to be a symbol or icon (such as a crosshair or target), and it does not contain any text to reproduce in markdown format.

# CONDUIT

T he power of the gods flows through you! As a vessel for divine magic, you don't just keep your allies in the fight. You make those allies more effective, even as you rain divine energy down upon your foes. While the deity or saint you serve might have other faithful and clergy, you are special among worshippers, receiving your abilities from the highest source.
...
> "The gods judge our actions, and our inaction" **Dazar**

![A black and white target symbol, consisting of a solid black circle at the center with white crosshairs running vertically and horizontally through it, enclosed by two concentric circles. The image appears to be a graphical symbol or icon.](image-url-placeholder)

*Note: The image contains only a graphic and does not contain any textual content to reproduce in markdown.*
...
Additionally, you can gain more piety by praying to the gods—but beware! Doing so can easily draw their ire, as the gods hate to be annoyed. Whenever you roll to gain piety at the start of your turn, you can pray (no action required). If you do, your roll gains the following additional effects:
...
The image contains a black and white target or crosshair symbol centered in the image. There is no text present in the image to be reproduced.

![target symbol](image-url)

(The image shows a target or crosshair symbol. There is no text present in the image.)
...
|------------------------------------|----------------------------|
| Image: magic triangle icon<br>Self | Image: target icon<br>Self |
...
| Magic, Ranged                | Maneuver                            | <b>Magic, Ranged</b>                 | <b>Triggered</b>                    |
|------------------------------|-------------------------------------|--------------------------------------|-------------------------------------|
| Image: Ranged icon Ranged 10 | Image: Target icon Self or one ally | Image: triangle ruler icon Ranged 10 | Image: target reticle icon One ally |
...
**Ray of Wrath** *You unleash a blast of holy light upon your foe.* **Magic, Ranged, Strike Main action** e Ranged 10 x One creature or object Power Roll + Intuition:
...
- á 3 + I holy damage é 5 + I holy damage
- í 8 + I holy damage
...
Power Roll + Intuition: á 2 + I corruption damage é 5 + I corruption damage
...
| ≤11   | 3 + Image: black square holy damage; vertical pull 2 |
|-------|------------------------------------------------------|
| 12–16 | 5 + Image: black square holy damage; vertical pull 3 |
...
| ≤11   | 2 + <span>Image: black square with white I</span> corruption damage |
|-------|---------------------------------------------------------------------|
| 12–16 | 4 + <span>Image: black square with white I</span> corruption damage |
| 17+   | 6 + <span>Image: black square with white I</span> corruption damage |
...
| Range                                                                              | Effect                                                                                                                                                          |
|------------------------------------------------------------------------------------|-----------------------------------------------------------------------------------------------------------------------------------------------------------------|
| <span style="border: 1px solid; border-radius: 8px; padding:2px 8px;">≤11</span>   | 3 + <span style="display:inline-block;width:14px;height:14px;background:#000;color:#fff;text-align:center;vertical-align:middle;">■</span> holy damage; slide 1 |
| <span style="border: 1px solid; border-radius: 8px; padding:2px 8px;">12–16</span> | 5 + <span style="display:inline-block;width:14px;height:14px;background:#000;color:#fff;text-align:center;vertical-align:middle;">■</span> holy damage; slide 2 |
| <span style="border: 1px solid; border-radius: 8px; padding:2px 8px;">17+</span>   | 8 + <span style="display:inline-block;width:14px;height:14px;background:#000;color:#fff;text-align:center;vertical-align:middle;">■</span> holy damage; slide 3 |
...
Power Roll + Intuition: á 3 + I holy damage

é 6 + I holy damage í 9 + I holy damage
...
The image contains a circular target-like symbol, with concentric circles and crosshair lines passing through the center. There is no text present in the image.

on their next power roll é 5 + I corruption damage; P<v, the target takes a bane on their next power roll í 8 + I corruption damage; P<s, the target takes a bane on their next power roll Heroic Abilities You make use of a number of heroic abilities, all of which channel piety to empower them. **3-Piety Ability** Choose one heroic ability from the following options, each of which costs 3 piety to use. (*Quick Build:* Violence Will Not Aid Thee.) **Call the Thunder Down (3 Piety)** *You ask your saint for thunder and your prayer is answered.* **Area, Magic, Ranged Main action** e 3 cube within 10 x Each enemy in the area Power Roll + Intuition: á 2 sonic damage; push 1 é 3 sonic damage; push 2 í 5 sonic damage; push 3 **Effect:** You can push each willing ally in the area the same distance, ignoring stability. **Font of Wrath (3 Piety)** *A brilliant column of holy light appears on the battlefield, striking out at nearby enemies.* **Magic, Ranged Main action** e Ranged 10 x Special **Effect:** You summon a spirit of size 2 who can't be harmed, and who appears in an unoccupied space within distance. The spirit lasts until the end of your next turn. You and your allies can move through the spirit's space, but enemies can't. Any enemy who moves within 2 squares of the spirit for the first time in a combat round or starts their turn there takes holy damage equal to your Intuition score. **Judgment's Hammer (3 Piety)** *Your divine fury is a hammer that crashes down upon the unrighteous.* **Magic, Ranged, Strike Main action** e Ranged 10 x One creature or object Power Roll + Intuition: á 3 + I holy damage; A<w, prone é 6 + I holy damage; A<v, prone í 9 + I holy damage; A<s, prone and can't stand (save ends) (save ends). **5-Piety Ability** e Ranged 10 x One creature or object (save ends) (save ends) (save ends) e Ranged 10 x One creature stand up if prone. Draw Steel.indb 100 6/24/25 2:48 PM
...
**Effect:** The first time on a turn that the target deals damage to another creature, the target of this ability takes 1d10 lightning damage
...
- á 3 + I corruption damage; M<w, damage weakness 5
- é 6 + I corruption damage; M<v, damage weakness 5
- í 9 + I corruption damage; M<s, damage weakness 5
...
á 3 + I corruption damage; P<w, the target takes a bane
...
| <b>Magic, Ranged</b>                   | <b>Main action</b>                   |
|----------------------------------------|--------------------------------------|
| Image: [Magic triangle icon] Ranged 10 | Image: [Target icon] Three creatures |
...
**Area, Magic Maneuver** e 5 burst x Self and each ally in the area
...
- á 2 holy damage
- é 5 holy damage í 7 holy damage
- 
...
![triangle icon](data:image/png;base64,...) 3 aura
...
á 8 + I holy damage é 13 + I holy damage í 17 + I holy damage
...
![](data:image/png;base64,iVBORw0KGgoAAAANSUhEUgAAABoAAAABCAYAAAA4pmQfAAAACXBIWXMAAAsTAAALEwEAmpwYAAAAG0lEQVQImWP4////////fwYKBkYGBkYGAAI3AF03JtIWAAAAABJRU5ErkJggg==) 4 aura
...
**Magic, Ranged, Strike Main action** e Ranged 5 x One creature

Power Roll + Intuition:

- á 8 + I damage; A<w, prone and restrained (save ends) é 12 + I damage; A<v, prone and restrained
- (save ends) í 16 + I damage; A<s, prone and restrained (save ends)
...
- Power Roll + Intuition:
- á 3 sonic damage; push 3
- é 6 sonic damage; push 5
...
e Three 10 × 1 lines within 1 x Each enemy in the area
...
e Ranged 10 x One creature Power Roll + Intuition:

- á 9 + I corruption damage; r<w, weakened (save ends)
- é 14 + I corruption damage; r<v, weakened
- 
...
![target symbol](attachment:image.png)
...
![ruler icon](image-url) Ranged 10
...
**Area, Magic Maneuver** e 5 aura x Self and each ally in the area
...
- ![triangle ruler icon](image) 5 aura
...
| Magic, Ranged, Strike                           | Main action                                            |
|-------------------------------------------------|--------------------------------------------------------|
| <span>Image: angled ruler icon</span> Ranged 10 | <span>Image: target icon</span> One creature or object |

Power Roll + Intuition:

| <span style="border:1px solid #000; border-radius:5px; padding:1px 5px;">≤11</span>   | 9 + <span>Image: black square</span> holy damage; slide 3  |
|---------------------------------------------------------------------------------------|------------------------------------------------------------|
| <span style="border:1px solid #000; border-radius:5px; padding:1px 5px;">12–16</span> | 13 + <span>Image: black square</span> holy damage; slide 4 |
| <span style="border:1px solid #000; border-radius:5px; padding:1px 5px;">17+</span>   | 18 + <span>Image: black square</span> holy damage; slide 6 |
...
| <b>Magic, Ranged</b>           | <b>Maneuver</b>                      |
|--------------------------------|--------------------------------------|
| Image: Ruler icon<br>Ranged 10 | Image: Spiral arrow icon<br>One ally |
...
**Area, Magic Maneuver** e Self; see below x Self
...
**Magic, Ranged Main action** e Ranged 10 x Special
...
| ≤11   | 3 + Image: [black rectangle] damage |
|-------|-------------------------------------|
| 12–16 | 5 + Image: [black rectangle] damage |
| 17+   | 8 + Image: [black rectangle] damage |
...
| Power Roll + Image: Intuition icon Intuition:<br>Image:  icon <span style="border:1px solid #000; padding:2px; border-radius:3px;">≤11</span> 10 + Image: Corruption die icon corruption damage;<br><span style="background:black; color:white; padding:1px 3px;">A &lt; WEAK</span> , weakened (save ends) |                                           |

- é 15 + I corruption damage; A<v, weakened
	- (save ends)
...
When you roll for piety at the start of your turn and you pray, you gain 1 additional piety.
...
"Understanding the mystery, requires ignorance of the mystery." **Embers**

Draw Steel.indb 112 6/24/25 2:48 PM
...
|-------|-----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|----------------------------------|
| 1st   | Elemental Specialization, Essence, Hurl<br>Element, Persistent Magic, Practical Magic, Specialization Feature,<br>Specialization Triggered Action, Enchantment, Elementalist Ward, Elementalist Abilities | Two signature, 3, 5              |
...
| 6th   | Perk, Wyrding, New 9-Essence Ability                                                                                                                                                                      | Two signature, 3, 5, 5, 7, 9     |
| 7th   | Characteristic Increase, Mantle of Quintessence, Surging Essence, Skill Increase                                                                                                                          | Two signature, 3, 5, 5, 7, 9     |
| 8th   | Perk, Specialization Feature, 11-Essence Ability                                                                                                                                                          | Two signature, 3, 5, 5, 7, 9, 11 |
| 9th   | Grand Wyrding, New 11-Essence Ability                                                                                                                                                                     | Two signature, 3, 5, 5, 7, 9, 11 |
| 10th  | Characteristic Increase, Breath, Essential Being, One, Perk, Skill Increase                                                                                                                               | Two signature, 3, 5, 5, 7, 9, 11 |
...
When you use an ability outside of combat that lets you spend unlimited essence on its effect, you can use it as if you had spent an amount of essence equal to your Victories. (Such abilities aren't part of the core rules for the elementalist but might appear in future products.)
...
Power Roll + R**eason:** á 2 + R damage é 4 + R damage í 6 + R damage
...
| Magic                                       | Maneuver                       |
|---------------------------------------------|--------------------------------|
| Image: [triangle symbol]<br>Self; see below | Image: [target symbol]<br>Self |
...
|---------------------------------|-----------------------|
| Image: triangle ruler Ranged 10 | Image: target Special |
...
The image provided contains a simple graphic or symbol rather than a block of text. It depicts a black circle at the center, bisected vertically and horizontally by thick black lines, all enclosed within a thin circular outline. This resembles a target or crosshair symbol. There is no textual content present in the image to reproduce as markdown.

![circular image with crosshair](Image of a circle with a thick cross and a filled center)
...
**Earth, Magic, Melee Main action** e Melee 1 x Special

**Main action**

![target icon](https://via.placeholder.com/15)
Special
...
e Melee 1 x One mundane object
...
The image contains a black and white target symbol. There is no text present in this image.
...
| ≤11   | 2 + <b>R</b> | corruption damage |
|-------|--------------|-------------------|
| 12–16 | 4 + <b>R</b> | corruption damage |
| 17+   | 6 + <b>R</b> | corruption damage |
...
Power Roll + R**eason:** á 2 fire damage
...
| ≤11   | 3 + <b style="background:black;color:white;padding:1px 4px;">R</b> corruption damage |
|-------|--------------------------------------------------------------------------------------|
| 12–16 | 6 + <b style="background:black;color:white;padding:1px 4px;">R</b> corruption damage |
| 17+   | 9 + <b style="background:black;color:white;padding:1px 4px;">R</b> corruption damage |

**Effect:** You can teleport up to a number of squares equal to your Reason score.

![](_page_119_Picture_1.jpeg)

á 2 + R fire damage; push 2

é 5 + R fire damage; push 3

í 7 + R fire damage; push 4
...
| Power Roll + <b>Reason</b> :<br>≤11: 2 psychic damage<br>12–16: 4 psychic damage<br>17+: 6 psychic damage                                                                                                                                                            |                                                |
| <b>Persistent 1:</b> At the start of your turn, you can use a maneuver to use this ability again without spending essence.                                                                                                                                           |                                                |
| <b>The Flesh, a Crucible (3 Essence)</b><br><i>Fire engulfs your target and continues to churn.</i>                                                                                                                                                                  |                                                |
| <b>Fire, Magic, Ranged, Strike</b><br>▧ Ranged 10                                                                                                                                                                                                                    | <b>Main action</b><br>🕒 One creature or object |
| Power Roll + <b>Reason</b> :<br>≤11: 5 + <b>R</b> fire damage<br>12–16: 8 + <b>R</b> fire damage<br>17+: 11 + <b>R</b> fire damage                                                                                                                                   |                                                |
| <b>Persistent 1:</b> If the target is within distance at the start of your turn, you can make the power roll again without spending essence.                                                                                                                         |                                                |
| <b>Invigorating Growth (3 Essence)</b><br><i>Mushrooms erupt from a foe, sapping their vitality to spread strengthening spores.</i>                                                                                                                                  |                                                |
| <b>Green, Magic, Ranged, Strike</b><br>▧ Ranged 10                                                                                                                                                                                                                   | <b>Main action</b><br>🕒 One creature           |
| Power Roll + <b>Reason</b> :<br>≤11: 4 + <b>R</b> poison damage<br>12–16: 7 + <b>R</b> poison damage<br>17+: 11 + <b>R</b> poison damage                                                                                                                             |                                                |
| <b>Effect:</b> Mushrooms cover the target's body. While the mushrooms are on the target, you and any ally adjacent to the target gain 1 surge whenever the target takes damage. The mushrooms can be removed by the target or an adjacent creature as a main action. |                                                |
| <b>Ripples in the Earth (3 Essence)</b><br><i>Like a stone was dropped into a pond, waves in the earth radiate from you.</i>                                                                                                                                         |                                                |
| Earth, Magic, Ranged                                                                                                                                                                                                                                                 | Maneuver                                       |
| Image: Ranged icon Ranged 10                                                                                                                                                                                                                                         | Image: Special icon Special                    |

í 8 damage; M<s, prone
...
![A bold, black-and-white target symbol consisting of concentric circles and crosshairs. There is no text in this image.](image.png)

There is no recognizable text to transcribe in this image.

The image contains a symbol of concentric circles with four intersecting lines, often referred to as a "target" or "bullseye" symbol. There is no text present in the image.
...
- á The target can shift 1 square from the edge of the hole to the nearest unoccupied space of their choice.
- é The target falls into the hole.
- í The target falls into the hole and can't reduce the height of the fall.
...
Your body is strengthened by your mind's connection to the element of permanence. You have a +6 bonus to Stamina, and you gain an additional +3 bonus to Stamina whenever you gain a level past 2nd in this class.

###### Disciple of Fire

Your connection to fire allows you to protect yourself from it, even as you rip away the protections of others. You have fire immunity equal to 5 plus your level in this class. Additionally, fire damage you deal ignores a target's fire immunity.
...
There is no text present in the provided image.

Each form has a prerequisite level that you must attain in this class <sup>t</sup> before you can adopt it. Some animal forms grant you temporary Stamina. You lose this temporary Stamina when you revert back to your true form.
...
| Magic, Ranged, Void                                 | Maneuver                                        |
|-----------------------------------------------------|-------------------------------------------------|
| <span>Image: Triangular arrow icon</span> Ranged 10 | <span>Image: Target/reticle icon</span> Special |
...
| Green Animal Forms |       |           |               |      |                    |                    |                                                                                                                                                                                                                                                       |
|--------------------|-------|-----------|---------------|------|--------------------|--------------------|-------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
| Animal Type        | Level | Temporary | Speed         | Size | Stability<br>Bonus | Melee Damage Bonus | Special                                                                                                                                                                                                                                               |
...
| Great cat          | 3rd   | 5         | 6 (climb)     | 2    | +0                 | +1/+1/+1           | As a maneuver, jump up to 3 squares in any direction. If you land on an<br>enemy of you size or smaller, that enemy is knocked prone and you can<br>make a melee free strike against them as part of the maneuver.                                    |
| Giant frog         | 4th   | 5         | 5 (swim)      | 2    | +0                 | +0/+0/+0           | Your melee free strike has a distance of melee 3. When you take the<br>Advance move action, you can high or long jump up to half your speed in<br>addition to your normal speed.                                                                      |
| Horse              | 4th   | 5         | 8             | 2    | +1                 | +0/+0/+0           | You can use the Charge main action as a maneuver. You can't use two<br>Charge main actions on the same turn.                                                                                                                                          |
...
| Giant spider       | 6th   | 0         | 5 (climb)     | 2    | +0                 | +0/+1/+2           | You have a double edge on melee free strikes against creatures you are<br>hidden from.                                                                                                                                                                |
| Giant snake        | 7th   | 5         | 5             | 3    | +0                 | +0/+1/+2           | Whenever you obtain a tier 2 or tier 3 result on a melee free strike, you can<br>automatically grab the target. While grabbed this way, the target takes 2<br>damage at the start of each of their turns.                                             |
| Kangaroo           | 7th   | 0         | 7             | 1L   | +1                 | +0/+0/+4           | If you get a critical hit with a melee free strike, the target is dazed<br>(save ends). When you take the Advance move action, you can high or long<br>jump up to half your speed in addition to your normal speed.                                   |
...
| Shark              | 8th   | 0         | 8 (swim only) | 2    | +0                 | +2/+2/+2           | You can breathe in water but can't breathe outside of it. Additionally, you<br>have an edge on strikes against targets who are bleeding or winded.                                                                                                    |
| Giant octopus      | 9th   | 5         | 5 (swim)      | 3    | +2                 | +0/+0/+0           | You can breathe in water. Additionally, you can target two creatures or objects<br>with your melee free strike, and a target of your melee free strike is grabbed by<br>you on a tier 2 or tier 3 result. You can have up to eight creatures grabbed. |
| Rhinoceros         | 9th   | 10        | 8             | 2    | +5                 | +2/+2/+2           | Whenever you make a melee free strike as part of the Charge main action,<br>it gains an edge.                                                                                                                                                         |
| King terror lizard | 10th  | 20        | 5             | 4    | +3                 | +2/+2/+2           | Your melee free strike is a 1 burst with the Area keyword and the Strike<br>keyword.                                                                                                                                                                  |
|                    |       |           |               |      |                    |                    |                                                                                                                                                                                                                                                       |

*the mystery reveals that two s*

```

The provided image does not contain any discernible text; it appears to be a graphical symbol resembling a target or crosshair, with no alphanumeric or word characters present. No text-based markdown can be extracted from this image.

![Target symbol](image-url)

*Note: The image displays a target or crosshair symbol consisting of concentric circles and a cross intersecting at the center. There is no text present in this image to represent in markdown.*
...
**Area, Earth, Green, Magic, Ranged Maneuver** e 3 cube within 10 x Special

**Maneuver**

![icon](https://img.icons8.com/emoji/48/target-emoji.png) Special
...
- á 5 + R poison damage
- é 9 + R poison damage í 12 + R poison damage
...
- á 3 fire damage
- é 5 fire damage í 8 fire damage
...
- á 5 + R fire damage; A<w, restrained (save ends)
- é 9 + R fire damage; A<v, restrained (save ends)
- í 12 + R fire damage; A<s, restrained (save ends)
...
**Earth, Magic Main action** e Self x Self
...
|-----------------------------|----------------------------|
| Image: Ruler icon Ranged 10 | Image: Spiral icon Special |

**Special:** The number of creatures you target with this ability is determined by your power roll.

Power Roll + R**eason:**

| <span style="border:1px solid #000; border-radius:5px; padding:2px 6px;"><math>≤11</math></span> | One creature |
|--------------------------------------------------------------------------------------------------|--------------|
|--------------------------------------------------------------------------------------------------|--------------|
...
The image displays a black crosshair or target symbol on a white background. There is no text present in the image.
...
The image contains a black-and-white target symbol or crosshair, with a circle, cross, and filled black quadrants. There is no text content to transcribe.

###### Hide of Tenfold Shields

Your animal forms become hardier. You gain temporary Stamina equal to your level in this class when you enter an animal form in combat, which is added to any temporary Stamina provided by the animal form.
...
á 8 + R fire damage é 13 + R fire damage í 17 + R fire damage
...
á 9 + R corruption damage

- é 10 + R corruption damage; the target has line of effect only to creatures and objects within 4 squares of them until the start of your next turn
- í 15 + R corruption damage; the target has line of effect only to adjacent creatures and objects until the start of your next turn
...
- á 2 corruption damage; A<w, restrained (save ends) é 3 corruption damage; A<v, restrained (save ends)
- 
- í 5 corruption damage; A<s, restrained (save ends)
...
The image contains a black and white crosshair or target symbol. It does not contain any text to represent in markdown format.
...
**Fire, Green, Magic, Ranged, Void Maneuver** e Ranged 10 x Self or one ally
...
- á You teleport the target up to 4 squares.
- é You teleport the target up to 6 squares.
- í You teleport the target up to 8 squares.
...
The image contains only a symbol that looks like a target or a crosshair, consisting of a circle divided into quarters with a cross and a filled black center. There is no visible text in the image.
...
|-----------------------------------|------------------------------|
| Image: Triangle icon<br>Ranged 10 | Image: Swirl icon<br>Special |
...
| <b>Area, Fire, Magic, Ranged</b>       | <b>Main action</b>                        |
|----------------------------------------|-------------------------------------------|
| Image: cube area icon 5 cube within 10 | Image: target icon Each enemy in the area |

Power Roll + R**eason:**

á 7 fire damage; the Director loses 2 Malice (see *Draw Steel: Monsters*)

- é 10 fire damage; the Director loses 3 Malice
- í 15 fire damage; the Director loses 4 Malice

**Effect:** The Director's Malice can become negative as a result of this ability.

| Source of Earth<br><span style="font-weight:normal;">Elemental</span>                                                                                                                                                                                                                             |                                                                | Level 8 Brute     |                                                                                                    |
|---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|----------------------------------------------------------------|-------------------|----------------------------------------------------------------------------------------------------|
| <b>45</b><br><span style="font-weight:normal;">Stamina</span>                                                                                                                                                                                                                                     | <b>Immunity:</b> —<br><b>Weakness:</b> —                       |                   | <b>5</b><br><span style="font-weight:normal;">Free Strike</span>                                   |
| <b>6</b><br><span style="font-weight:normal;">Speed</span>                                                                                                                                                                                                                                        | <b>Movement:</b> Run, Fly, Hover, Teleport                     |                   | <b>Melee:</b> 2<br><b>Ranged:</b> 10                                                               |
| <b>2</b><br><span style="font-weight:normal;">Size</span>                                                                                                                                                                                                                                         | <b>5</b><br><span style="font-weight:normal;">Stability</span> |                   |                                                                                                    |
| <b>M</b> ight +3                                                                                                                                                                                                                                                                                  | <b>A</b> gility +1                                             | <b>R</b> eason -5 | <b>I</b> ntuition -5<br><b>P</b> resence -3                                                        |
| <b>⚔ Boulder Bash</b><br><span style="font-style:italic;">Melee, Ranged, Strike, Weapon</span><br><b>⚔</b> Melee 2 or ranged 10<br><span style="white-space:pre;">         &lt;11     5 damage; push 3<br/>         12–16   9 damage; push 4<br/>         17+     12 damage; push 5       </span> |                                                                |                   | <b>Signature Action</b><br>2d10 +3<br><span style="font-size:smaller;">1 creature or object</span> |
...
**Area, Magic, Ranged, Void Main action** e Ranged 10 x Special
...
![Triangle ruler icon](triangle_ruler_icon.png) 5 burst

**Area, Earth, Magic Main action** e 5 burst x Each enemy in the area

Power Roll +R**eason:**

- á M<w, prone é M<v, prone
- í M<s, prone
...
Power Roll + R**eason:** á 13 + R fire damage; I<w, dazed (save ends) é 18 + R fire damage; I<v, dazed (save ends)

í 25 + R fire damage; I<s, dazed (save ends)
...
Draw Steel.indb 130 6/24/25 2:48 PM
...
**Skills:** You have the Nature skill (see Skills in Chapter 9: Tests). Then choose any two skills from the exploration or intrigue skill groups. (*Quick Build:* Nature, Alertness, Jump.)
...
Basics <sup>t</sup> **Fury Advancement**
...
When you use an ability outside of combat that lets you spend unlimited ferocity on its effect, such as To the Utmost End, you can use it as if you had spent an amount of ferocity equal to your Victories.
...
This image does not contain any textual information. It depicts a black circle with a white crosshair overlay, resembling a target symbol or a sight reticle.

###### Beast Shape

Whenever you select a kit, you can instead select a stormwight kit (see Stormwight Kits). Your stormwight kit grants you a number of benefits, including benefits tied to your Growing Ferocity feature.
...
**Berserker Growing Ferocity** Ferocity Benefit <sup>2</sup> Whenever you use the Knockback maneuver, the forced movement distance gains a bonus equal to your Might score. 4 The first time you push a creature on a turn, you gain 1 surge. 6 You gain an edge on Might tests and the Knockback maneuver. 8 (4th level) The first time you push a creature on a turn, you gain 2 surges. 10 (7th level) You have a double edge on Might tests and the Knockback maneuver. 12 (10th level) Whenever you use a heroic ability, you gain 10 temporary Stamina. Additionally, whenever you make a power roll that imposes forced movement on a target, the forced movement distance gains a bonus equal to your Might score.
...
| —                                 | <b>Triggered</b>        |
|-----------------------------------|-------------------------|
| Image: striped triangle icon Self | Image: target icon Self |
...
**Magic, Melee Triggered** e Melee 1 x Self or one creature
...
|                           | Triggered               |
|---------------------------|-------------------------|
| Image: triangle icon Self | Image: target icon Self |
...
![A black and white target icon, consisting of a solid black circle in the middle intersected by a crosshair and surrounded by two concentric circles, all on a white background. No text is present.](image-url)

There is no textual content to reproduce from this image.

![center target symbol](center_target_symbol)
...
Power Roll + Might: á 3 + M damage; push 1 é 6 + M damage; push 2
...
![](_page_135_Picture_29.jpeg)

######## To the Death!

*Your reckless assault leaves you tactically vulnerable.*

**Melee, Strike, Weapon Main action** e Melee 1 x One creature or object Power Roll + Might: á 3 + M damage é 6 + M damage
...
- **Target:** 1 burst
- **Affects:** Each enemy in the area
...
- **Target:** Melee 1
- **Affects:** One creature or object
...
Melee, Strike, Weapon Main action** e Melee 1 x One creature or object Power Roll + Might: á 4 + M damage; M<w, bleeding and weakened (save ends) é 6 + M damage; M<v, bleeding and weakened (save ends) í 10 + Mdamage; M<s, bleeding and weakened (save ends) **Effect:** You can deal 1d6 damage to yourself to deal an extra 1d6 damage to the target. **Make Peace With Your God! (5 Ferocity)

Make Peace with Your God! (5 re

| —                        | <b>Free maneuver</b>      |
|--------------------------|---------------------------|
| Image: [arrow icon] Self | Image: [target icon] Self |
...
![](https://via.placeholder.com/20x20.png?text=)

This image contains a circular crosshair or target-like icon with a filled black center.
...
**Melee, Strike, Weapon Maneuver** e Melee 1 x One willing ally
...
**Melee, Strike, Weapon Main action** e Melee 1 x One creature Power Roll + Might: á 3 + M damage; P<w, dazed and frightened (save ends) é 5 + M damage; P<v, dazed and frightened (save ends) í 8 + M damage; P<s, dazed and frightened (save ends) **Phalanx-Breaker (5 Ferocity)** *Organizing your forces like feckless creatures of Law. Pitiful.* **Melee, Weapon Main action** e Self; see below x Self

**Effect:** You shift up to your speed and make one power roll that targets up to three enemies you move adjacent to during this shift. Power Roll + Might:

- á 2 damage; A<w, dazed (save ends)
- é 4 damage; A<v, dazed (save ends)
- í 6 damage; A<s, dazed (save ends)
...
á 2 damage; push 1; M<w, dazed (save ends)

é 5 damage; push 2; M<v, dazed (save ends)

í 7 damage; push 3; M<s, dazed (save ends)
...
When you are in a negotiation with an animal or elemental, you treat your Renown as 1 higher than usual. This stacks with the increase to

your effective Renown in a negotiation with an animal of your type while in animal form (see Stormwight Kits).
...
| Magic                          | Maneuver                              |
|--------------------------------|---------------------------------------|
| Image: triangle symbol<br>Self | Image: bullseye/target symbol<br>Self |

**Effect:** Until the end of the encounter or until you are dying, each enemy who starts their turn adjacent to you and has P<sis frightened until the end of their turn.
...
| Magic                            | Maneuver                            |
|----------------------------------|-------------------------------------|
| Image: magic symbol icon<br>Self | Image: maneuver target icon<br>Self |

**Effect:** Until the end of the encounter or until you are dying, each creature you make a melee strike against who has P<vis taunted until the end of their next turn. Additionally, when you use an ability that deals rolled damage against any enemy taunted by you, the ability deals extra damage equal to twice your Might score and increases its potency by 1.
...
![](https://upload.wikimedia.org/wikipedia/commons/2/2e/Crosshair1.png)
...
At the start of your turn, you can end any restrained condition on you. Additionally, you have a double edge on checks made to escape being confined or imprisoned.
...
⚔️ Melee 1 🎯 The triggering creature
...
| Magic                              | Maneuver                            |
|------------------------------------|-------------------------------------|
| Image: triangle magic icon<br>Self | Image: target maneuver icon<br>Self |
...
The image contains a circular target or crosshair with a dot in the center. There is no text present in the image.
...
á 7 + M damage; push 3 é 11 + M damage; push 5 í 16 + Mdamage; push 7
...
á 4 + M damage; P<w, frightened (save ends) é 6 + M damage; P<v, frightened (save ends)

í 10 + Mdamage; P<s, frightened (save ends)

- 10\* damage; ███████ frightened (save ends)
...
######## Riders of the Storm (9 Ferocity)
...
You exhibit ever-stronger signs of how the force of the Primordial Chaos flow within you. Whenever you show strong emotion or increase your ferocity, elemental motes attuned to your mood flit around you, and your skin changes in appearance to reflect an element of your choice.
...
| Image: [icon] | <b>Elemental Ferocity (11 Ferocity)</b> |
|---------------|-----------------------------------------|
|---------------|-----------------------------------------|
...
*You strike so no damage is wasted.* **Magic, Melee, Strike, Weapon Main action**

e Melee 1 x One creature

Power Roll + Might: á 6 + M damage
...
| Image: black arrow | <b>Death Comes for You All! (11 Ferocity)</b> |
|--------------------|-----------------------------------------------|
|--------------------|-----------------------------------------------|

*You use your weapon to create a destructive shockwave.* **Area, Magic, Melee, Weapon Main action**

e 3 burst x Each enemy in the area

Power Roll + Might: <sup>á</sup> 7 damage; push 3 <sup>é</sup> 10 damage; push 5 <sup>í</sup> 15 damage; push 7
...
- <sup>á</sup> 3 damage; vertical pull 3 <sup>é</sup> 5 damage; vertical pull 5 <sup>í</sup> 8 damage; vertical pull 7
- 
...
| <b>Power Roll + <span style="background:black;color:white;padding:1px 4px;">M</span>ight:</b> |                                             |

**Main action**  

![target icon](https://upload.wikimedia.org/wikipedia/commons/thumb/5/55/Target_icon.svg/24px-Target_icon.svg.png) One creature

###### Power Roll + Might:

- á 11 + M damage é 16 + M damage
- í 21 + Mdamage
...
á 12 + M damage é 18 + M damage í 24 + Mdamage
...
The image represents a circular target-like symbol, filled black in the center, with vertical and horizontal cross lines.
...
á 4 psychic damage; any target who is a minion dies
...
| Magic                        | Maneuver                          |
|------------------------------|-----------------------------------|
| Image: triangle icon<br>Self | Image: spiral target icon<br>Self |
...
á 2 + M damage; M<w, grabbed é 5 + M damage; M<v, grabbed

í 11 + M damage; M<s, grabbed

![](_page_145_Picture_33.jpeg)
...
While you are in your crow form, your size is 1T and you can fly. You can use the Hide maneuver as a free maneuver, and you can use your allies as cover when you hide. You can't use any abilities while in this form.
...
| Image: decorative symbol | <b>Unbalancing Attack</b>                             |
|--------------------------|-------------------------------------------------------|
|                          | <i>A wild assault forces your foe onto their back</i> |

**Melee, Strike, Weapon Main action**

e Melee 1 x One creature or object

- Power Roll + Might: á 4 + M damage; A<w, prone
- é 7 + M damage; A<v, prone
- í 9 + M damage; A<s, prone
...
**Skills:** You have the Psionics skill (see Skills in Chapter 9: Tests). Then choose any two skills from the interpersonal or lore skill groups. (*Quick Build:* Psionics, Read Person, Timescape.)
...
Through extensive physical and psionic training, you have learned to unlock the full potential of your body. As you shape the growth of your power, you choose a null tradition from the following options, each of which grants you a skill. (*Quick Build:* Chronokinetic and the Psionics skill.)
...
|-------|-----------------------------------------------------------------------------------------------------------------------------------------------------------------|----------------------------------|---------------------|
| 1st   | Null Tradition, Discipline, Null<br>Field, Inertial Shield, Discipline<br>Mastery, Null Speed, Psionic<br>Augmentation, Psionic Martial Arts,<br>Null Abilities | Two signature,<br>3, 5           | —                   |
| 2nd   | Perk, Tradition Feature, Tradition<br>Ability                                                                                                                   | Two signature,<br>3, 5           | 5                   |
| 3rd   | Psionic Leap, Reorder, 7-Discipline<br>Ability                                                                                                                  | Two signature,<br>3, 5, 7        | 5                   |
| 4th   | Characteristic Increase, Discipline<br>Mastery Improvement, Enhanced<br>Null Field, Perk, Regenerative Field,<br>Skill                                          | Two signature,<br>3, 5, 7        | 5                   |
| 5th   | Tradition Feature, 9-Discipline<br>Ability                                                                                                                      | Two signature,<br>3, 5, 7, 9     | 5                   |
| 6th   | Elemental Absorption, Elemental<br>Buffer, Perk, Tradition Ability                                                                                              | Two signature,<br>3, 5, 7, 9     | 5, 9                |
| 7th   | Characteristic Increase, Discipline<br>Mastery Improvement, Psi Boost,<br>Improved Body, Skill                                                                  | Two signature,<br>3, 5, 7, 9     | 5, 9                |
| 8th   | Perk, Tradition Feature,<br>11-Discipline Ability                                                                                                               | Two signature,<br>3, 5, 7, 9, 11 | 5, 9                |
| 9th   | I Am the Weapon, Tradition Ability                                                                                                                              | Two signature,<br>3, 5, 7, 9, 11 | 5, 9, 11            |
| 10th  | Characteristic Increase, Discipline<br>Mastery Improvement, Manifold<br>Body, Manifold Resonance, Order,<br>Perk, Skill                                         | Two signature,<br>3, 5, 7, 9, 11 | 5, 9, 11            |

discipline equal to your Victories. At the start of each of your turns during combat, you gain 2 discipline.
...
| Area, Psionic            |                                            |
|--------------------------|--------------------------------------------|
| Image: Aura icon  1 aura | Image: Target icon  Each enemy in the area |
...
Your instinct for danger let you predict attacks before they happen.
...
| Psionic                              | Triggered                          |
|--------------------------------------|------------------------------------|
| Image: psionic triangle icon<br>Self | Image: target/trigger icon<br>Self |
...
Whenever you use your Inertial Shield ability, you can use the Disengage move action as a free maneuver.
...
![Crosshair Symbol](image-url)

The image depicts a crosshair symbol—there is no text present in the image.
...
|---------------------|---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|--|
| Discipline          | Benefit                                                                                                                                                                                           |  |
| 2                   | Whenever you use the Knockback maneuver, the forced movement<br>distance gains a bonus equal to your Intuition score.                                                                             |  |
| 4                   | The first time in a combat round that you take damage or are force<br>moved, you gain 1 surge, even if you resist the effect.                                                                     |  |
| 6                   | You gain an edge on the Grab and Knockback maneuvers.                                                                                                                                             |  |
| 8 (4th level)       | The first time in a combat round that you take damage or are force<br>moved, you gain 2 surges, even if you resist the effect.                                                                    |  |
| 10 (7th level)      | You have a double edge on the Grab and Knockback maneuvers.                                                                                                                                       |  |
| 12<br>(10th level)  | Whenever you force move a target, the forced movement distance<br>gains a bonus equal to your Intuition score. Additionally, whenever<br>you use a heroic ability, you gain 10 temporary Stamina. |  |
...
![](https://upload.wikimedia.org/wikipedia/commons/4/46/ISO_7010_W002.svg)

This image does not contain any text, only a graphic symbol. No further markdown representation of text is possible.
...
![icon](icon-placeholder) 1 burst

**Area, Psionic, Weapon Main action** e 1 burst x Each enemy in the area
...
á 4 + A damage; A<w, grabbed é 7 + A damage; A<v, grabbed í 9 + A damage; A<s, grabbed
...
á 4 + A damage; taunted (EoT) é 5 + A damage; taunted (EoT), slide 1 í 6 + A damage; taunted (EoT), slide 2
...
- á 5 + A psychic damage; vertical pull 1
- é 8 + A psychic damage; vertical pull 2
- í 11 + A psychic damage; vertical pull 3
...
| ≤11   | 4 + <b>A</b> damage; push 2 |
|-------|-----------------------------|
| 12–16 | 6 + <b>A</b> damage; push 4 |
...
| <b>Power Roll + <span style="background:#000;color:#fff;padding:2px;">A</span>gility:</b> |                                             |

á 4 + A damage; A<w, weakened (save ends) é 7 + A damage; A<v, weakened (save ends) í 9 + A damage; A<s, weakened (save ends)
...
| ≤11   | 7 + <b style="background-color:black;color:white;padding:1px 4px;">A</b> damage  |
|-------|----------------------------------------------------------------------------------|
| 12-16 | 10 + <b style="background-color:black;color:white;padding:1px 4px;">A</b> damage |
| 17+   | 13 + <b style="background-color:black;color:white;padding:1px 4px;">A</b> damage |
...
í 6 + A psychic damage; I<s, the target goes out of phase (save ends)
...
Draw Steel.indb 151 6/24/25 2:48 PM
...
| Psionic                               | Maneuver                               |
|---------------------------------------|----------------------------------------|
| <span>Image: Psionic icon</span> Self | <span>Image: Maneuver icon</span> Self |
...
á 8 + A damage; slide 1 é 12 + A damage; slide 3

í 16 + A damage; slide 5

![](_page_155_Figure_62.jpeg)
...
á 6 cold damage; A<w, slowed (save ends)

é 9 cold damage; A<v, slowed (save ends)

í 13 cold damage; A<s, slowed (save ends)
...
á 8 + A psychic damage; vertical pull 3 é 12 + A psychic damage; vertical pull 5 í 16 + A psychic damage; vertical pull 7
...
á You gain 10 temporary Stamina.

- é You gain 15 temporary Stamina.
- í You gain 20 temporary Stamina.
...
| Psionic                     | Maneuver                  |
|-----------------------------|---------------------------|
| Image: Psionic icon<br>Self | Image: Maneuver icon Self |
...
| Psionic                              | Maneuver                              |
|--------------------------------------|---------------------------------------|
| Image: triangle/psionic icon<br>Self | Image: bullseye/maneuver icon<br>Self |
...
![icon](https://upload.wikimedia.org/wikipedia/commons/4/45/Red_triangle.svg) Self
...
|--------------------------------|--------------------------------------|
| Image: Melee icon Melee 1      | Image: Clock arrow icon One creature |

**Trigger:** The target moves or uses a main action.

Power Roll + Agility:

| <span style="border:1px solid #ccc; border-radius:8px; padding:2px 6px; font-size:90%">≤11</span>   | 7 + <b>A</b> damage; <span style="background:black; color:white; font-weight:bold; padding:0 3px;">I &lt; WEAK.</span> restrained (save ends)     |
|-----------------------------------------------------------------------------------------------------|---------------------------------------------------------------------------------------------------------------------------------------------------|
| <span style="border:1px solid #ccc; border-radius:8px; padding:2px 6px; font-size:90%">12–16</span> | 10 + <b>A</b> damage; <span style="background:black; color:white; font-weight:bold; padding:0 3px;">I &lt; AVERAGE.</span> restrained (save ends) |
| <span style="border:1px solid #ccc; border-radius:8px; padding:2px 6px; font-size:90%">17+</span>   | 13 + <b>A</b> damage; <span style="background:black; color:white; font-weight:bold; padding:0 3px;">I &lt; STRONG.</span> restrained (save ends)  |
...
|-----------------------------------------------------------------------------------------------------|--------------------------------------------------------------------------------------|---|---------------------------------------------------------------------------------------|---------|
| <b>Power Roll + <span style="background-color:black;color:white;padding:0 4px;">A</span>gility:</b> |                                                                                      |   |                                                                                       |         |
| ≤11                                                                                                 | 10 + <span style="background-color:black;color:white;padding:0 4px;">A</span> damage | ; | <span style="background-color:black;color:white;padding:0 4px;">A &lt; WEAK</span>    | grabbed |
| 12–16                                                                                               | 14 + <span style="background-color:black;color:white;padding:0 4px;">A</span> damage | ; | <span style="background-color:black;color:white;padding:0 4px;">A &lt; AVERAGE</span> | grabbed |
| 17+                                                                                                 | 18 + <span style="background-color:black;color:white;padding:0 4px;">A</span> damage | ; | <span style="background-color:black;color:white;padding:0 4px;">A &lt; STRONG</span>  | grabbed |
...
**Psionic Main action** e Self x Self
...
|---------------------------------------------------|----------------------------------------------|
| <span>Image: triangle icon</span> Self; see below | <span>Image: circular arrow icon</span> Self |
...
- á 6 damage; M<w, dazed
- é 8 damage; M<v, dazed
- í 12 damage; M<s, dazed

![target-like symbol](image)

*(The image consists of a circular target-like symbol with crosshairs, but contains no textual content.)*
...
| <b>Power Roll +</b> Image: intuition icon <b>Intuition:</b> |                                       |

á Vertical slide 5

| <b>12–16</b> | Vertical slide 7 |
|--------------|------------------|
| <b>17+</b>   | Vertical slide 9 |
...
Whenever you use an ability that is a main action or a maneuver with the Psionic keyword, you can spend additional discipline to apply a psi boost to it and enhance its effects. You can apply multiple psi boosts to an ability, but only one instance of each specific boost. You can use the following psi boosts.
...
![](_page_158_Picture_51.jpeg)

There is no text visible in this image. Only a partial circular line with a vertical line intersecting at the bottom is present.

![target symbol](image-url)

The image consists of a black-and-white target or crosshair symbol, consisting of a black filled circle centered within a larger circle, with vertical and horizontal lines passing through the center. There is no text in the image.
...
At the start of each of your turns during combat, you gain 3 discipline instead of 2.
...
- Power Roll + Agility: á 13 + A damage; M<w, the target is suppressed (save ends)
- é 19 + A damage; M<v, the target is suppressed (save ends)
- í 24 + Adamage; M<s, the target is suppressed (save ends)
...
á 9 + A damage; push 5; I<w, dazed (save ends) é 13 + A damage; push 7; I<v, dazed (save ends)

í 18 + Adamage; push 10; I<s, dazed (save ends)
...
- á 12 psychic damage; push 3
- é 17 psychic damage; push 5
- í 23 psychic damage; push 7
...
**Psionic, Ranged Free triggered** e Ranged 10 x One creature

**Trigger:** The triggering creature starts their turn.

Power Roll + Intuition:

- á I<w, the target loses their turn
- é I<v, the target loses their turn

í I<s, the target loses their turn
...
**Psionic Free triggered** e Self x Self
...
- á You gain 20 temporary Stamina.
- é You gain 30 temporary Stamina.
- í You gain 40 temporary Stamina.
